...
When running the project, you can access the API documentation as a guide to consum the endpoints and getting started with the API. Follow this link to access the API documentation.

http://localhost:8080/swagger-ui.html

For further reading about the tools and dependencies, refer to the Reference Documentation.
